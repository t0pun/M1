...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister register = e.getPRegister(locals);
        return new RTLXOri(register, reg, succ);
    }//toRTL
...
class UPPAnd extends UPPBinOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister register_e1 = e1.getPRegister(locals);
        PRegister register_e2 = e2.getPRegister(locals);
        RTLInst and = new RTLAnd(register_e1,register_e2, reg, succ);
        RTLInst RTL_e2 = e2.toRTL(locals, globals,register_e2, and);
        return e1.toRTL(locals, globals,register_e1,RTL_e2);
    }//toRTL
...
class UPPOr extends UPPBinOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister register_e1 = e1.getPRegister(locals);
        PRegister register_e2 = e2.getPRegister(locals);
        RTLInst or = new RTLOr(register_e1,register_e2, reg, succ);
        RTLInst RTL_e2 = e2.toRTL(locals, globals,register_e2, or);
        return e1.toRTL(locals, globals,register_e2,RTL_e2);
    }//toRTL
...
class UPPLoad extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister addr_register = addr.getPRegister(locals);
        return new RTLLoad(addr_register, reg, succ);
    }//toRTL
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,ArrayList<String> globals, RTLInst succ) {
        PRegister register_cond = cond.getPRegister(locals);
        RTLInst RTL_i1 = i1.toRTL(locals, globals, succ);
        RTLInst RTL_i2 = i2.toRTL(locals, globals, succ);
        RTLGtz gtz = new RTLGtz(register_cond, RTL_i1, RTL_i2);
        return cond.toRTL(locals, globals, register_cond, gtz);
    }//toRTL
...
class UPPProcCall extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) {
        ArrayList<PRegister> regsiter_args = new ArrayList<PRegister>();
        for (int i = 0; i < args.size(); i++) {
            UPPExpr arg = args.get(i);
            regsiter_args.add(arg.getPRegister(locals));
        }
        return new RTLProcCall(callee,regsiter_args, succ);
    }//toRTL
...
class UPPSeq extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        for (int i = 0; i < locals.size(); i++) {
            Pair<String, PRegister> elements = locals.get(i);
            args.add(elements.right);
        }
        RTLInst RTL_i2 = i2.toRTL(locals, globals, succ);
        return i1.toRTL(locals, globals,RTL_i2);
    }//toRTL        
...
class UPPProc extends UPPDef {
    ...
    RTLDef toRTL (ArrayList<String> globals) {
        ArrayList<PRegister> regArgs = new ArrayList<PRegister>();
        ArrayList<PRegister> regLocals = new ArrayList<PRegister>();
        ArrayList<Pair<String, PRegister>> trans = new ArrayList<Pair<String, PRegister>>();

        for (String arg: args) {
            PRegister register=new PRegister();
            Pair<String, PRegister> couple = new Pair<String, PRegister>(arg,register);
            regArgs.add(register);
            regLocals.add(register);
            trans.add(couple);
        }

        for (String local : locals) {
            PRegister register = new PRegister();
            Pair<String, PRegister> pair = new Pair<String, PRegister>(local, register);
            regLocals.add(register);
            trans.add(pair);
        }
        RTLInst inst = code.toRTL(trans, globals, new RTLEnd());
        return new RTLProc(name, regArgs, regLocals, inst);
    }//toRTL
